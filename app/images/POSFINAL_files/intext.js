...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  browserver: '',
  browsersupport: '0',
  appsig: 'S20141406637906z',
  subscribe: '',
  subscribe2: '',
  sbstatus: '',
  supnow: '',
  checksb: 0,
  branduid: '7e2a25efb1a1aa8b60ca8bae763153ca|1405425028',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://localhost:9000/',
  page_url: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '24.241.12.59'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 24.241.12.59 not supported. uip=' + properties.userip);
   return (0);
  }
...
function analyzePage()
{
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://localhost:9000/'; */
...
function checkConfig()
{
 ...
 properties.p4mode= parseInt(parseTag(xml, "<p4mode>", "</p4mode>"));
 properties.moretest= parseInt(parseTag(xml, "<allowmore>", "</allowmore>"));

 writeLog(1,'checkconfig() sbstatus=['+properties.sbstatus+']');
 writeLog(1,'checkconfig() p4mode=['+properties.p4mode+']');
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('fe52o6md1s6pop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function doMouseClickfe52o6md1s6()
 {
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg fe52o6md1s6_3, fe52o6md1s6_4, ... fe52o6md1s6_13 
     ...
     if (1==1 && dynamicColorMode ==1)
      {
       ...
       var css=getfe52o6md1s6CSS(sc);
       span.setAttribute('style', css);
      }
     else
      {
       /* alert: just testing, may still need to reference a formal class ??? */
       span.className = 'fe52o6md1s6';
      }


     span.id = 'fe52o6md1s6' + "_" + properties.spancount;
     span.name='fe52o6md1s6' + "_" + properties.spancount; 
...
function build_clickthru(domain, afid, ecb, ptclickflag, url)
{
 ...
 function buildAdPopHTML(title, desc, vurl, clickurl, wpdesc,  wplink)
 {
  ...
  var wrapper = '<div class="u2dsf3d" style="text-decoration:none !important; z-index:'+z+'; overflow:visible;">'
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'fe52o6md1s6spinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickfe52o6md1s6,   false);
  addEvent(adpop_span, "click", doMouseClickfe52o6md1s6);
  ...
  try
   {
    ...
    s.setAttribute('id', 'fe52o6md1s6sup');
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'fe52o6md1s6frame';
  gframe.name = 'fe52o6md1s6frame';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('fe52o6md1s6frame');
 ...
 function setupfe52o6md1s6CSS()
 {
  writeLog(1, 'setupfe52o6md1s6CSS()');
  ...
  // style.innerHTML = '.fe52o6md1s6 { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.fe52o6md1s6 { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.fe52o6md1s6 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';
   ...
   var style = document.createElement('style');
   style.type = 'text/css';
   style.styleSheet.cssText= '.u2dsf3d  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
   ...
   {
    // style.innerHTML = '.fe52o6md1s6 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.fe52o6md1s6 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';

  document.getElementsByTagName('head')[0].appendChild(style);

 var style = document.createElement('style');
 style.type = 'text/css';
 style.innerHTML = '.u2dsf3d  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
 document.getElementsByTagName('head')[0].appendChild(style);
 ...
 function getfe52o6md1s6CSS(linkcolor)
 {
  var css='';
...
function stopSpinner()
{
 ...
 function valid_ad_word(t)
 {
  ...
  for(var i=0; i<words.length; i++)
   {
     if (words[i] == 'more' && properties.moretest ==1) continue;
