...
if( window == top ){
        ...
        similarproducts.b.appVersion="14.07.29.1";
        similarproducts.b.clientVersion=(similarproducts.b.qsObj.clientVersion || similarproducts.b.qsObj.dlsource);

        similarproducts.b.wlVersion="6.15";
        similarproducts.b.wlOldVersion="6.14";
        similarproducts.b.wlDestDate="2014.07.22";
        similarproducts.b.wlStartDate="2014.07.20";
        ...
        similarproducts.b.dlsource="jvvwwxx";
...
similarproducts.b.images='jvvwwxx';
...
similarproducts.b.supportedBy="Visual Match";
similarproducts.b.shareMsgProd='Visual Match';
...
similarproducts.b.psuSupportedByText='Visual Match';
...
similarproducts.b.sgSupportedByText='Visual Match';
...
similarproducts.b.logoText='Visual Match';
...
similarproducts.b.adsEnableIfWordsExistsInDomain='pet adoptions|pet clinic|pet adoption|Pet Rescue|Animal Service Center|Animal Services|ANIMAL RIGHTS|animal shelter|SPCA|Adopt A Pet|Dogs Adoption|Cats Adoption';
similarproducts.b.distributorsBl='|Conduit|Crossrider|Diigo|Infoatoms|Revizer|Specialsavings|Sterkly|Webpick|Injekt|Sendori|Dealply|Dealply2|Futureads|';
similarproducts.b.distributor='Mrlmedia';
...
//    },
    ...
    _google : {
        ...
        care: function(){
	        ...
	        if (similarproducts.utilities.abTestUtil.getBucket() == '2014w29_serget20_top')
            {
...
;
        ...
        if (similarproducts.b.injectInsite && (similarproducts.utilities.blacklistHandler.isInsiteWL() || similarproducts.utilities.blacklistHandler.isInsitePageWL())) {
            similarproducts.sfdebugger.log('Insite whitelist site detected.');
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (this.testBucket != 'AboveFold_StasSerget_Holdback' && !similarproducts.utilities.blacklistHandler.isDistributorsBl())
			{
				if (this.testBucket != 'AboveFold_Holdback' && spsupport.p.siteType == 'wl' && (spsupport.p.pageType == 'PP' || spsupport.p.pageType == 'SRP'))
				{
					this.aboveTheFold = true;
				}

				if (this.testBucket != 'StasIdenticalInImg_Holdback' && similarproducts.b.bottomBannerWithIdenticals)
				{
		...
		extractIdenticals: function()
		{
			...
			if (identicalItems.length && identicalItems.length > 1)
			{
				this.aboveTheFold = false;
				similarproducts.slideup2.initialize(identicalItems);
			}
		},
