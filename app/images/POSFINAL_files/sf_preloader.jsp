...
//                window.console.log("catch " + ex);
    ...
    blacklistHandler: blacklistHandler = function()
    {
        ...
        var insitePagesWhiteList = /.+\.craigslist\.org\/pet|.+\.craigslist\.org\/search\/pet|petstew\.com\/index\.html|petadoption\.ocpetinfo\.com\/Adopt|animall\.org\/adopt|sfbay\.craigslist\.org\/pas|sfbay\.craigslist\.org\/pet|sfbay\.craigslist\.org\/pen\/pet|sfbay\.craigslist\.org\/sfc\/pet|sfbay\.craigslist\.org\/sby\/pet|sfbay\.craigslist\.org\/eby\/pet|sfbay\.craigslist\.org\/nby\/pet|sfbay\.craigslist\.org\/scz\/pet|walmart\.com\/cp\/pet-supplies\/5440|tractorsupply\.com\/en\/store\/pet|ebay\.com\/chp\/pet-supplies|ebay\.com\/chp\/Dog-Supplies-\/20742|ebay\.com\/chp\/Cat-Supplies-\/20737|pinterest\.com\/all\/animals|photobucket\.com\/images\/dog\?page=1|dogperday\.com\/gallery\/index\.php\?cat_id=1|reddit\.com\/r\/aww|imgur\.com\/r\/pets|imgur\.com\/r\/cats|imgur\.com\/r\/dogs|shine\.yahoo\.com\/blogs\/pets|animalplanet\.com\/pets|ellentv\.com\/pets|peoplepets\.com\/people\/pets|today\.com\/pets|sheknows\.com\/pets-and-animals|selectsmart\.com\/DOG|selectsmart\.com\/CAT/i;
        ...
        var secureDomainsWhiteList = "|getdigital.de|sony.it|seesimilar.com|findsimilar.com|google.com|etsy.com|victoriassecret.com|bonubon.com|bukowskismarket.com|cubus.com|fyndiq.se|halebop.se|limango.com.tr|komplett.se|markafoni.com|mio.se|saatvesaat.com.tr|stayhard.se|tictail.com|tre.se|metashop.at|sopo.at|elektroshopkoeck.com|sportkiste.at|";
        ...
        function isInsiteWhiteList(){
            ...
            ourHostName = ourHostName.toLowerCase();
            insiteWhiteList = insiteWhiteList.toLowerCase();

            subsHosts = ourHostName.split('.');

            for (var i=0, l=subsHosts.length-1; i<l; i++)
            {
                if (insiteWhiteList.indexOf('|'+subsHosts.join('.')+'|') !== -1)
                {
                    insiteWL = 1;
                    break;
                }
        ...
        function isInsitePageWhiteList()
        {
            ...
            if (document.location.href.match(insitePagesWhiteList))
            {
                insitePageWL = 1;
            }
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!similarproducts.b.qsObj.dlsource) {
            similarproducts.b.qsObj.dlsource = "jvvwwxx";
        }
